    ...
    <main className="container mx-auto px-6 py-12">
      <div className="relative grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          <button className="inline-flex items-center justify-center rounded-full border border-black px-6 py-2 text-sm font-medium text-gray-900 hover:bg-[#9e6144] hover:text-white transition-colors">
            READ MORE
          </button>
        </div>
